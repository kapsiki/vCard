  ...
  >
    ...
    >
      ...
      <div class="flex">
        ...
        <button
          class="font-extrabold leading-none tracking-wide select-none shrink-0 p-3 text-white bg-red-500 rounded hover:bg-emerald-500 focus:bg-emerald-500 transition-colors duration-200 focus:outline-none"
          @click="cropPhoto"
        >
          Crop photo
        </button>
